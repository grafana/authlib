...
func TestHasPermissionInToken(t *testing.T) {
	tests := []struct {
		...
		{
			name:             "Token containing *.grafana.app never matches (group/resource:verb)",
		...
		{
			name:             "Token containing *.grafana.app never matches (group:verb)",
		...
		{
			name:             "Token containing *.grafana.app never matches (wildcard verb)",
		...
		{
			name:             "Token containing *.grafana.app never matches (no resource, wildcard verb)",
		...
		{
			name:             "Token containing *.ext.grafana.app never matches (group/resource:verb)",
			tokenPermissions: []string{"*.ext.grafana.app/datasources:get"},
			group:            "prometheus.ext.grafana.app",
			resource:         "datasources",
			verb:             "get",
			want:             false,
		},
		{
			name:             "Token containing *.ext.grafana.app never matches (group:verb)",
			tokenPermissions: []string{"*.ext.grafana.app:get"},
			group:            "folder.ext.grafana.app",
			resource:         "folders",
			verb:             "get",
			want:             false,
		},
		{
			name:             "Token containing *.ext.grafana.app never matches (wildcard verb)",
			tokenPermissions: []string{"*.ext.grafana.app/datasources:*"},
			group:            "prometheus.ext.grafana.app",
			resource:         "datasources",
			verb:             "get",
			want:             false,
		...
		{
			name:             "Token containing *.ext.grafana.app never matches (no resource, wildcard verb)",
			tokenPermissions: []string{"*.ext.grafana.app:*"},
			group:            "folder.ext.grafana.app",
			resource:         "folders",
			verb:             "get",
			want:             false,
		...
		{
			name:             "Token containing *.ext.grafana.com never matches (group/resource:verb)",
			tokenPermissions: []string{"*.ext.grafana.com/datasources:get"},
			group:            "prometheus.ext.grafana.com",
			resource:         "datasources",
			verb:             "get",
			want:             false,
		},
		{
			name:             "Token containing *.ext.grafana.com never matches (group:verb)",
			tokenPermissions: []string{"*.ext.grafana.com:get"},
			group:            "folder.ext.grafana.com",
			resource:         "folders",
			verb:             "get",
			want:             false,
		},
		{
			name:             "Token containing *.ext.grafana.com never matches (wildcard verb)",
			tokenPermissions: []string{"*.ext.grafana.com/datasources:*"},
			group:            "prometheus.ext.grafana.com",
			resource:         "datasources",
			verb:             "get",
			want:             false,
		...
		{
			name:             "Token containing *.ext.grafana.com never matches (no resource, wildcard verb)",
			tokenPermissions: []string{"*.ext.grafana.com:*"},
			group:            "folder.ext.grafana.com",
			resource:         "folders",
			verb:             "get",
			want:             false,
